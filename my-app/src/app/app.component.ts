...
export class AppComponent {
  ...
  getRandomKey() {
    if(this.lang=="ENG"){
      ...
      var alphabet =       ["ا","ب","ت","ث","ج","ح","خ","د","ذ","ر","ز","س","ش","ص","ض","ط","ظ","ع","غ",
        "ف","ق","ك","ل","م","ن","ه","و","ي","أ","إ","ى","ء","ئ","آ","ة","ؤ"];
    }
  ...
  getFrequency() {
    ...
    //remove spaces
    if(this.lang=="ENG"){
      input = this.rightText.replace(/[^A-Za-z]/g, "")

    }else {
      input = this.rightText.replace(/[^ا-ي]/g, "")
  ...
  getTableData(){
    ...
    if(this.lang=="ARA"){
      this.tableRow2 = this.arabicOrderByFreq;
    }else {
      this.tableRow2 = this.englishOrderByFreq;
